...
{
    public sealed class MeshBuilderParallel : System.IDisposable
    {
        private VoxelRenderJobParallel greedyJob;
        ...
        {
            greedyJob = new VoxelRenderJobParallel()
            {
            ...
            if (!parallel)
                handle = greedyJob.Schedule(chunk.Size.x + chunk.Size.y + chunk.Size.z + 3, default);
            else
                handle = greedyJob.ScheduleParallel(chunk.Size.x + chunk.Size.y + chunk.Size.z + 3, 64, default);
        }
